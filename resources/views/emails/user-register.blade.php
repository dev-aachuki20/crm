    ...
    <td>
        ...
        <div class="mail-desc">
            ...
            <div style="text-align: center;">
                <a href="#" style="display: inline-block; background-color: #007bff; color: #fff; padding: 8px 16px; text-decoration: none; border-radius: 5px; font-size: 16px;">Reset Password</a>
            </div>
            <p style="font-size:14px;">
            ...
            <div class="mail-desc">
                <ul style="list-style-type: none; padding: 0;">
                    <li style="font-size: 14px;">
                        Email: <a href="mailto:" target="_blank" style="text-decoration: none; color: #007bff;"></a>
                    </li>
                </ul>
            </div>
        </div>
