<div class="row">
    ...
    <div class="col-12 col-lg-4">
        <div class="form-group">
            ...
            <input type="text" name="phone" id="phone" class="form-control" value="{{ isset($interaction->phone) ? $interaction->phone : old('phone') }}" />
        </div>
    </div>
    ...
    <div class="col-12 col-lg-12">
        <div class="form-group">
            ...
            <select class="form-control" name="qualification" id="qualification">
                <option value="">@lang('cruds.interaction.fields.select_qualification')</option>
    ...
    <div class="col-12 col-lg-12">
        <div class="form-group">
            ...
            <textarea class="form-control" name="customer_observation" id="customer_observation">{{ isset($interaction->customer_observation) ? $interaction->customer_observation : old('customer_observation') }}</textarea>
        </div>
    </div>
